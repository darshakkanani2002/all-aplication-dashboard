...
import { Img_Url, Test_Api } from './DailyConfig';
import LanguageSelect from './LanguageSelected';
import DailySidebar from './DailySidebar';
import DeleteModal from './DailyModal/DeleteModal';
  ...
  return (
    <div>
      ...
      <div className='py-3'>
        ...
        />
        <div className='px-3'>
          <div className='side-container category-form p-3 margin-top-90'>
        ...
        <div className='side-container my-5 px-3'>
